...
<section id="content">
    ...
    <form id="create" method="post" action="includes/db-create-employee.php" enctype="multipart/form-data">
    	 <fieldset>
            <h6>Login Credentials</h6>
            <div class="clearfix"></div>
            <div class="leftcol">
                <input type="email" name="userName" placeholder="Username@managio.com" autofocus maxlength="100" required="required" tabindex="1"/>
            </div>
            <div class="rightcol">
        ...
        <fieldset>
            ...
            <div class="rightcol">
            	<input type="text" name="pfNumber" placeholder="P F Number" maxlength="16" />
                <input type="text" name="panNumber" placeholder="Pan Number" maxlength="10" />
                <input type="text" name="adharNumber" placeholder="Aadhar Number" onkeyup="number(this)" maxlength="12"/>
            </div>
		</fieldset>
