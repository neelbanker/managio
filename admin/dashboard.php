...
<section id="content">
	<ul>
        <?php	
            $sql = "SELECT * FROM ems_task WHERE creatorID = '$xi' ORDER BY ID DESC LIMIT 5";
            $result = mysqli_query($conn, $sql); ?>
    ...
    <ul>
      	<?php	
			$sql = "SELECT * FROM ems_notes WHERE receiverID = '$xi' ORDER BY ID DESC LIMIT 5 ";
			$result = mysqli_query($conn, $sql); ?>
    	<?php	if(mysqli_num_rows($result) > 0)
				{ ?>
    ...
    <ul>
        <?php	
			$sql = "SELECT * FROM ems_leave WHERE empID = $xi or receiverID = $xi ORDER BY ID DESC LIMIT 5 ";
			$result = mysqli_query($conn, $sql); ?>
    	<?php	if(mysqli_num_rows($result) > 0)
				{ ?>
